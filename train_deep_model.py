...
X = X.reshape(X.shape[0], X.shape[1], 1)  # (70, 18, 1)
...
layers.Conv1D(filters=64, kernel_size=3, activation='relu', kernel_regularizer=keras.regularizers.l2(0.001), input_shape=(18, 1)),
...
model.save("models/eeg_authentication_model.h5")
print("Model saved as 'models/eeg_authentication_model.h5'")
