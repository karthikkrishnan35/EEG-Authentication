...
model_path = os.path.join('models', 'eeg_authentication_model.h5')
try:
    # Correct way to load a model - using a single file path
    model = tf.keras.models.load_model(model_path)
    print("Model loaded successfully")
except Exception as e:
    print(f"Error loading model: {e}")
    print("Creating a test model instead...")
    
    # Create a simple test model
    # The input shape should match your feature dimensions
    input_size = 18  # Assuming 6 features per channel × 3 channels
